...
class BooleanModel:
    ...
    def build(self) -> None:
        """No-op build method for interface compatibility with other retrieval models."""
        return None
    ...
    def search(self, query: str, top_k: int = 10) -> List[Tuple[int, float]]:
        ...
        ranked_results = [(doc_id, 1.0) for doc_id in sorted(result)]
